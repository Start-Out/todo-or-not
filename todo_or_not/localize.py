...
LOCALIZE = {
    ...
    "ko_kr": {
        ...
        "error_subprocess_api_request_failed": "오류: 서브 프로세스에서 API 요청에 실패하였습니다",
        ...
        "warning_file_permission_error": "경고: 파일 권한 오류",
    ...
    "bu_mm": {
        ...
        "error_subprocess_api_request_failed": "အမှား- subprocess အတွင်း API တောင်းဆိုမှု မအောင်မြင်ပါ",
        ...
        "warning_file_permission_error": "သတိပေးချက်- ဖိုင်ခွင့်ပြုချက် အမှားဖြစ်ပါသည်။",
